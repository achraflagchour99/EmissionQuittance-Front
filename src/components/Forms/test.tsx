...
const Example = () => {
    ...
    useEffect(() => {
        // Fetch data from the API and update the tableData state
        fetchData()
    ...
    const fetchData = async () => {
        // Make your API request here to fetch the data
        const response = await fetch('http://localhost:8081/polices');
